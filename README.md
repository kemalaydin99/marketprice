# Market Price Listener Exercise
============================================
https://github.com/kemalaydin99/marketprice
============================================
...
```
1- Commandline {project dir}> mvn spring-boot:run
...
...
``` 
    1- Convert in memory repositories into JPA repos with database integrity.
    2- Add unit tests to increase coverage to 100%.
    3- Add acceptance tests with Cucumber.
    4- Create Jenkins  and Docker files for automated CI/CD pipline. 
    5- Provide example json files for unit testing.
``` 
